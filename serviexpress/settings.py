...
ALLOWED_HOSTS = ["*"]   # Render requiere esto al inicio
...
MIDDLEWARE = [
    ...
    # 👇 NECESARIO PARA RENDER (staticfiles)
...
# ---------------------------------------------
# Database (Local + Render compatible)
# ---------------------------------------------

# Base local → sigue funcionando igual
DATABASES = {
    'default': {
...
# Si Render entrega DATABASE_URL → sobrescribe configuración
